...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        funcionario1.atualizarNome("Chris");
        funcionario2.atualizarSalarioHora(22.5); // Nao atualiza pq eh menor do que o atual
        System.out.println(funcionario1.info());
        System.out.println(funcionario2.info());
        ...
        for (int dia=0; dia < 5; dia++){
            funcionario1.adicionarDiaDeTrabalho(8);
            funcionario2.adicionarDiaDeTrabalho(4.5);
        }
        System.out.println(funcionario1.info());
        System.out.println(funcionario2.info());
    }
